...
class ReplaceGetOrSetInspection : AbstractApplicabilityBasedInspection<KtDotQualifiedExpression>(
    ...
    override fun isApplicable(element: KtDotQualifiedExpression): Boolean {
        if (!KtInspectionUtils.isTargetOfReplaceGetOrSetInspection(element)) return false
    ...
    override fun applyTo(element: KtDotQualifiedExpression, project: Project, editor: Editor?) {
        KtInspectionUtils.replaceGetOrSetWithPropertyAccessor(element, element.calleeName == OperatorNameConventions.SET.identifier, editor)
    }
}
