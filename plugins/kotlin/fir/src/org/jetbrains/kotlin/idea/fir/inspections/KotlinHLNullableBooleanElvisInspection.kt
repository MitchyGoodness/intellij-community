...
/**
 * A class for nullable boolean elvis inspection based on FIR
 *
 * For an elvis operation e.g., "<Nullable Boolean expression> ?: <Constant Boolean value>", this class detects and replaces it with
 * a boolean equality check e.g., "<Nullable Boolean expression> == <Constant Boolean value>". See
 * plugins/kotlin/idea/resources/inspectionDescriptions/KotlinHLNullableBooleanElvis.html for details.
 */
class KotlinHLNullableBooleanElvisInspection :
    AbstractHLInspection<KtBinaryExpression, KotlinHLNullableBooleanElvisInspection.NullableBooleanInput>(
        KtBinaryExpression::class
    ) {
    class NullableBooleanInput : HLApplicatorInput
    ...
    override val inputProvider: HLApplicatorInputProvider<KtBinaryExpression, NullableBooleanInput> =
        inputProvider {
            val lhsType = it.left?.getKtType() ?: return@inputProvider null
    ...
    override val applicator: HLApplicator<KtBinaryExpression, NullableBooleanInput> =
     ...
     *  - LHS must have a nullable boolean type. - This is checked by the "inputProvider" above.
     *
